...
function switchTab(tab) {
    ...
    if (tab === 'event') {
        document.getElementById('news-img').src = 'publics/images/tab-2/slide2.jpg';
        document.getElementById('news-title').innerText = 'EVENT';
        document.getElementById('news-date').innerText = '05-30 2022';
    } else {
        document.getElementById('news-img').src = 'publics/images/tab-2/slide1.jpg';
        document.getElementById('news-title').innerText = 'LATEST NEWS';
        document.getElementById('news-date').innerText = '05-30 2022';
    }
}
const slides = [
    "publics/images/tab-2/slide1.jpg",
    "publics/images/tab-2/slide2.jpg"
];
let currentSlide = 0;
let slideInterval;
